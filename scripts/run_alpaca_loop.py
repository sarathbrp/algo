...
def main() -> None:
    ...
    # Live: force news off in the merged config used by engines (already false in default.yaml).
    if not user_manager.multi_user and args.live:
        user_contexts[0].config.setdefault("news_sentiment", {})["enabled"] = False
